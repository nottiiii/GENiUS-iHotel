package md5ba937f4fd1029a8b57d9cd7ef8c20dfa;


public class SfImageEditorRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Syncfusion.SfImageEditor.XForms.Droid.SfImageEditorRenderer, Syncfusion.SfImageEditor.XForms.Android, Version=15.2451.0.40, Culture=neutral, PublicKeyToken=null", SfImageEditorRenderer.class, __md_methods);
	}


	public SfImageEditorRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SfImageEditorRenderer.class)
			mono.android.TypeManager.Activate ("Syncfusion.SfImageEditor.XForms.Droid.SfImageEditorRenderer, Syncfusion.SfImageEditor.XForms.Android, Version=15.2451.0.40, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}


	public SfImageEditorRenderer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == SfImageEditorRenderer.class)
	...
	public SfImageEditorRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == SfImageEditorRenderer.class)
