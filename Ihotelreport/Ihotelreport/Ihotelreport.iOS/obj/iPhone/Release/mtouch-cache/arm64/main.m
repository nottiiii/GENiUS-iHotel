...
extern void *mono_aot_module_Ihotelreport_iOS_info;
...
extern void *mono_aot_module_Syncfusion_SfChart_iOS_info;
extern void *mono_aot_module_NControl_iOS_info;
extern void *mono_aot_module_NControl_info;
extern void *mono_aot_module_NGraphics_info;
extern void *mono_aot_module_System_Xml_Linq_info;
extern void *mono_aot_module_NGraphics_iOS_info;
extern void *mono_aot_module_Ihotelreport_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Cross_Pie_Forms_info;
...
{
	mono_aot_register_module (mono_aot_module_Ihotelreport_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfChart_iOS_info);
	mono_aot_register_module (mono_aot_module_NControl_iOS_info);
	mono_aot_register_module (mono_aot_module_NControl_info);
	...
	mono_aot_register_module (mono_aot_module_Ihotelreport_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Cross_Pie_Forms_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Ihotelreport.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
