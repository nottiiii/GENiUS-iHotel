...
namespace Ihotelreport
{
    ...
    public partial class Staticreport : ContentPage
    {
        ...
        public async void GetJSON()
        {
            ...
            try
            {
                var response = await client.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/Getstaticrooms?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
                ...
                var response2 = await client2.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/Getcurrentrooms?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
                ...
                var response3 = await client3.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/Getinhousestatus?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
                string contactsJson3 = response3.Content.ReadAsStringAsync().Result;
                if (contactsJson3.Contains("An error has occurred"))
                {
                    R_Fit.Text = "0";
					G_Fit.Text = "0";
					O_Fit.Text = "-";
					...
					R_Vacant.Text = "0";
					O_Vacant.Text = "-";
                    Debug.WriteLine("Inhouse status Error");
                }
                else
                {
                ...
                var response4 = await client4.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/GetCurRoomBusiness?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
                ...
                var response5 = await client5.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/GetCurRevenue?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
                string contactsJson5 = response5.Content.ReadAsStringAsync().Result;
                if (contactsJson5.Contains("An error has occurred"))
                {
                    Debug.WriteLine("Revenue Summary Error");
                    A_Room.Text = "-";
                    R_Room.Text = "0";
                    A_Revenue.Text = "-";
                    R_Revenue.Text = "0";
                ...
                var response6 = await client6.GetAsync("http://hotelsoftware.in.th/Webrestful/api/Staticroom/GetCurPayment?szHotelDB=" + database + "&szServer=" + szServer + "&szDate1=" + datepick + "&szDeviceCode=1234");
